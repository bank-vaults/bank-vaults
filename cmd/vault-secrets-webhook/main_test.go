			...
			wantedContainers: []corev1.Container{
				corev1.Container{
					...
					Env: []corev1.EnvVar{
						...
						{Name: "VAULT_TTL_TERMINATE", Value: "false"},
						{Name: "VAULT_TTL_TERMINATE_SIGNAL", Value: "0"},
						{Name: "VAULT_TTL_TERMINATE_GRACE_PERIOD", Value: "0s"},
						{Name: "VAULT_TTL_TERMINATE_BEFORE", Value: "0s"},
					},
				},
			},
			mutated: true,
